                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" id="importDate" name="birthday" value="{{ old('birthday') }}">
                                @error('birthday')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" name="address" rows="5"></textarea>
                            @error('address')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
