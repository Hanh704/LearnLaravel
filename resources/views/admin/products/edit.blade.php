            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('ten_san_pham') is-invalid @enderror"
                                id="productName" name="ten_san_pham"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('ma_san_pham') is-invalid @enderror"
                                name="ma_san_pham" value="{{ old('ma_san_pham' , $product->ma_san_pham) }}">
                            @error('ma_san_pham')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('gia') is-invalid @enderror"
                                    name="gia" value="{{ old('gia' , $product->gia) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('gia_khuyen_mai') is-invalid @enderror"
                                    name="gia_khuyen_mai" value="{{ old('gia_khuyen_mai', $product->gia_khuyen_mai )}}">
                                <span class="input-group-text">VNĐ</span>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('mota') is-invalid @enderror" name="mota" rows="5">{{ old('mota',$product->mota )}}</textarea>
                        @error('mota')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" name="so_luong" value="{{ old('so_luong', $product->so_luong) }}">
                            @error('so_luong')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control" id="importDate" name="ngay_nhap"
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="category" name="trang_thai">
                                ...
                                <option value="1" {{ old('trang_thai', $product->trang_thai ) == 1 ? 'selected' : '' }}>ON</option>
                                <option value="0" {{ old('trang_thai', $product->trang_thai ) == 0 ? 'selected' : '' }}>OFF</option>
                            </select>
                            @error('trang_thai')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
